...
public class AllInfoNewBean {
    ...
    private ArrayList<StoreArrBean> store_arr;
    ...
    public ArrayList<StoreArrBean> getStore_arr() {
        return store_arr;
    }

    public void setStore_arr(ArrayList<StoreArrBean> store_arr) {
