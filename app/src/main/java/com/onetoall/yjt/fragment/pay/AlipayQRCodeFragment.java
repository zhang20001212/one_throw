...
public class AlipayQRCodeFragment extends BaseFragment implements ITabFragment {
    ...
    public static Fragment getInstance(PayRequestParameter parameter) {
        AlipayQRCodeFragment fragment = new AlipayQRCodeFragment();
    ...
    protected int getFragmentLayoutId() {
        return R.layout.fragment_qr_code_alipay;
    }
    ...
    private void loadDataFromServer() {
        mPayModel.collectMoneyByAlipayQrCode(parameter, new Callback<PayQRCode>() {
            @Override
